...
##########################################################################
##########################################################################
                     API="10_count_notification" 
                     google_sheet="https://docs.google.com/spreadsheets/d/1zjbeiOPiSIgYdOkE6USHIRxbIoZ8zLd4fZmxhKwJDnM/edit?gid=1610289956#gid=1610289956" 
                     id="6"                 #เปลี่ยน id ทุกครั้งที่ยิง
                     user="500";            #จำนวนผู้ใช้งาน
                     duration="1";         #วินาที
                     scenario="1"           #scenario="1" ยิงเเบบกำหนด request (duration ได้แค่ 1 วินาที)
                     cid="001"                #scenario="2" ยิงเเบบกำหนด VUs  (กำหนดว่า user x คน ใช้ระบบ x วินาที)
